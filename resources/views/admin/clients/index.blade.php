...
<br>
<button><a href="{{route('products.create')}}">Crear Clientes</a></button>

<button><a href="{{route('brands.create')}}">Crear Direcciones</a></button>
<button><a href="{{route('brands.index')}}">Ver Direcciones</a></button>
<br>
<br><br>
<div class="container">
